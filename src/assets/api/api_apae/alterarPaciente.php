...
if($postJson['requisicao'] == 'alterarPrimario'){

    $query = mysqli_query($mysqli, "UPDATE  pacientes SET nome = '$postJson[nome]', idade = '$postJson[idade]', 
    ...
    comoCriancaBrinca = '$postJson[comoCriancaBrinca]', interageComOsPais = '$postJson[interageComOsPais]'  WHERE '$postJson[id]' = id");
...
else if($postJson['requisicao'] == 'alterarSecundario'){

    $query = mysqli_query($mysqli, "UPDATE  pacientes2 SET interacaoComDemais = '$postJson[interacaoComDemais]', queixaPais = '$postJson[queixaPais]', 
    ...
    relatorio19 = '$postJson[relatorio19]',relatorio20 = '$postJson[relatorio20]'  WHERE '$postJson[id]' = id");
